...
class PostgresPolicyRepository:
    """
    Postgres policy repository: persists tenant- and workspace-scoped policies.
    """

    def __init__(self, *, context: PostgresContext) -> None:
        """
        Bind shared Postgres context for policy persistence.
        """
    ...
    async def __tenant_policy(
        ...
        *,
        ...
        async with connection.execute(
            ...
            SELECT *
            FROM policies
            WHERE tenant = $1 AND workspace IS NULL AND name = $2
            LIMIT 1
            """,
    ...
    async def __workspace_policy(
        ...
        *,
        ...
        async with connection.execute(
            ...
            SELECT *
            FROM policies
            WHERE tenant = $1 AND workspace = $2 AND name = $3
            LIMIT 1
            """,
