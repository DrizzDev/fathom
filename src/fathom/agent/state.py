    ...
    def get_recovery_action(self) -> Optional[Action]:
        ...
        if attempt == 1:
            return Action(
                ...
                confidence=0.5,
                reasoning="Stuck in loop, attempting navigation back",
            )
        elif attempt == 2:
            return Action(
                ...
                confidence=0.4,
                reasoning="Stuck in loop, attempting scroll to reveal new elements",
            )
        else:
            return Action(
                ...
                confidence=0.3,
                reasoning="Stuck in loop, resetting to home screen",
            )
