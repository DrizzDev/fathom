...
ANCHOR_RESERVE_CEILING: Final[float] = 0.5
DEFAULT_ANCHOR_RESERVE_TOP: Final[float] = 0.05
DEFAULT_ANCHOR_RESERVE_SIDE: Final[float] = 0.12
DEFAULT_ANCHOR_RESERVE_BOTTOM: Final[float] = 0.10
