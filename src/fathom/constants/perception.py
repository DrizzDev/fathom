...
KEYBOARD_MINIMUM_TOP_RATIO: Final[float] = 0.55
KEYBOARD_BOTTOM_REGION_RATIO: Final[float] = 0.42
KEYBOARD_MINIMUM_HEIGHT_RATIO: Final[float] = 0.25

KEYBOARD_MINIMUM_CONTOUR_COUNT: Final[int] = 24
KEYBOARD_EDGE_DENSITY_THRESHOLD: Final[float] = 0.035
