"""
Unit tests for UX rendering text normalization.
"""
...
class TestUXService:
    """
    Reasoning and evidence text is normalized before rendering.
    """

    def test_render_tool_call_normalizes_reasoning_and_evidence(self) -> None:
        service = UXService()
