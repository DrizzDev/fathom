...
class StepDraftComposerTest(unittest.TestCase):
    ...
    def test_grounded_launch_baseline_is_not_duplicated_by_step_draft(self) -> None:
        ...
        baseline = AuthoringBaseline(
            content="\n".join(
                (
                    "OPEN_APP: com.healthcare.userhtexpress",
            ...
            commands=(
                AuthoringBaselineCommand(
                    text="OPEN_APP: com.healthcare.userhtexpress",
        ...
        drafts = (
            self.__draft(step=0, text="OPEN_APP: com.healthcare.userhtexpress"),
        ...
        self.assertIsNotNone(result)
        assert result is not None
        self.assertEqual(result.text.splitlines().count("OPEN_APP: com.healthcare.userhtexpress"), 1)
